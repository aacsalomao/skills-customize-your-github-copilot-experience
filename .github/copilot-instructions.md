...
Sempre utilize o padrão [Conventional Commits](https://www.conventionalcommits.org/pt/v1.0.0/) ao realizar commits neste projeto. Isso garante clareza, organização e facilita o rastreamento de mudanças.